# Gate C1 (Phase 2): capture runner for the AEB kernel Dafny spec,
...
def main():
    ...
    (HERE / "raw_dafny_output_aeb.txt").write_text(
    ...
    (HERE / "run_manifest_dafny_aeb.json").write_text(json.dumps(manifest, indent=2))
