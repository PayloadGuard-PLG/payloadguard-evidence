# Phase 2, Gate C4: real capture of aeb_kernel_stp_suite.dfy - the
# Spec-Testing Proof suite run against aeb_kernel.dfy (included). All
...
TARGET = HERE / "aeb_kernel_stp_suite.dfy"
...
def main():
    ...
    (HERE / "raw_dafny_output_stp_suite_aeb.txt").write_text(
    ...
    (HERE / "run_manifest_dafny_stp_suite_aeb.json").write_text(json.dumps(manifest, indent=2))
