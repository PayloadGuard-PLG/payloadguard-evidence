# Gate C1 (Phase 2): capture runner for the renal-adjustment Dafny spec,
# mirroring examples/dosage_calculator/run_verify_dafny.py's discipline
...
def main():
    ...
    (HERE / "raw_dafny_output_renal.txt").write_text(
    ...
    (HERE / "run_manifest_dafny_renal.json").write_text(json.dumps(manifest, indent=2))
