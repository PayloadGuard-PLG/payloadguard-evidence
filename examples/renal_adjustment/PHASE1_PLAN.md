...
| REQ-RENAL-1a | eGFR is reported rounded to the nearest whole number before staging — the effective continuous G-stage boundaries for a real-valued input are 89.5/59.5/44.5/29.5/14.5, not the naive 90.0/60.0/45.0/30.0/15.0. **The base rounding requirement is KDIGO-sourced; the round-half-up tie-break specifically is a named, uncited design decision, corrected 2026-07-09** — KDIGO states no tie-breaking method, and the NKF Laboratory Engagement Working Group's implementation guidance (Miller et al., *Clin Chem* 2022;68(4):511-520, PMID 34918062) explicitly defers this to "the rounding logic of a laboratory information system." | KDIGO 2024, p. S153, Table 11 ("Implementation standards..."), for the base rounding requirement — **page corrected 2026-07-09 from a mis-cited S164 (that page number belongs to REQ-RENAL-7's Practice Point 4.2.4 citation below, not Table 11) to S153, confirmed against the actual PDF page footer; Table 11's full first appearance in the guideline body is at S184**; see `sources/kdigo-2024-gfr-staging.md`'s 2026-07-09 amendment for the tie-break correction. |
